...
func TestStableAnonymousErrorMapping(t *testing.T) {
	tests := []struct {
		...
		{name: "installation missing retry", err: anonymous.ErrInstallationLimit, status: 503, code: "dependency_unavailable"},
		{name: "network missing retry", err: anonymous.ErrNetworkLimit, status: 503, code: "dependency_unavailable"},
		{name: "installation concurrency", err: &anonymous.ConcurrencyLimitError{Scope: anonymous.LimitInstallation, RetryAfter: 120 * time.Second}, status: 429, code: "anonymous_installation_concurrency_limited", retry: "120"},
		{name: "network concurrency", err: errors.Join(errors.New("allocation failed"), &anonymous.ConcurrencyLimitError{Scope: anonymous.LimitNetwork, RetryAfter: 1500 * time.Millisecond}), status: 429, code: "anonymous_network_concurrency_limited", retry: "2"},
		{name: "concurrency zero retry", err: &anonymous.ConcurrencyLimitError{Scope: anonymous.LimitInstallation}, status: 503, code: "dependency_unavailable"},
		{name: "concurrency negative retry", err: &anonymous.ConcurrencyLimitError{Scope: anonymous.LimitNetwork, RetryAfter: -time.Second}, status: 503, code: "dependency_unavailable"},
		{name: "concurrency unknown scope", err: &anonymous.ConcurrencyLimitError{Scope: "other", RetryAfter: time.Second}, status: 503, code: "dependency_unavailable"},
		{name: "installation rate", err: &anonymous.RateLimitError{Scope: anonymous.LimitInstallation, RetryAfter: 1500 * time.Millisecond}, status: 429, code: "anonymous_installation_rate_limited", retry: "2"},
		{name: "network rate", err: errors.Join(errors.New("allocation failed"), &anonymous.RateLimitError{Scope: anonymous.LimitNetwork, RetryAfter: time.Minute}), status: 429, code: "anonymous_network_rate_limited", retry: "60"},
		{name: "minimum retry", err: &anonymous.RateLimitError{Scope: anonymous.LimitNetwork, RetryAfter: time.Millisecond}, status: 429, code: "anonymous_network_rate_limited", retry: "1"},
		{name: "large retry", err: &anonymous.RateLimitError{Scope: anonymous.LimitInstallation, RetryAfter: time.Duration(1<<63 - 1)}, status: 429, code: "anonymous_installation_rate_limited", retry: "9223372037"},
		{name: "rate missing retry", err: anonymous.ErrRateLimited, status: 503, code: "dependency_unavailable"},
		{name: "rate zero retry", err: &anonymous.RateLimitError{Scope: anonymous.LimitInstallation}, status: 503, code: "dependency_unavailable"},
		{name: "rate negative retry", err: &anonymous.RateLimitError{Scope: anonymous.LimitNetwork, RetryAfter: -time.Second}, status: 503, code: "dependency_unavailable"},
		{name: "rate unknown scope", err: &anonymous.RateLimitError{Scope: "other", RetryAfter: time.Second}, status: 503, code: "dependency_unavailable"},
