...
var catalogJA = map[messageID]string{
	...
	msgLocalAddressReadFailed: "有効なローカルアドレスを読み取れませんでした。例のように直接指定してください: nt anonymous http localhost 3000",
	msgPortReadFailed:         "有効なポートを読み取れませんでした。例のように直接指定してください: nt anonymous http localhost 3000",
