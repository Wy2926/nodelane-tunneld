...
var catalogES = map[messageID]string{
	...
	msgLocalAddressReadFailed: "no se leyó una dirección local válida; indícala directamente, por ejemplo: nt anonymous http localhost 3000",
	msgPortReadFailed:         "no se leyó un puerto válido; indícalo directamente, por ejemplo: nt anonymous http localhost 3000",
