...
var catalogHI = map[messageID]string{
	...
	msgLocalAddressReadFailed: "मान्य लोकल पता नहीं पढ़ा गया; इसे सीधे दें, जैसे: nt anonymous http localhost 3000",
	msgPortReadFailed:         "मान्य पोर्ट नहीं पढ़ा गया; इसे सीधे दें, जैसे: nt anonymous http localhost 3000",
