...
var catalogKO = map[messageID]string{
	...
	msgLocalAddressReadFailed: "유효한 로컬 주소를 읽지 못했습니다. 다음과 같이 직접 지정하세요: nt anonymous http localhost 3000",
	msgPortReadFailed:         "유효한 포트를 읽지 못했습니다. 다음과 같이 직접 지정하세요: nt anonymous http localhost 3000",
