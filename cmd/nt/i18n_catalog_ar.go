...
var catalogAR = map[messageID]string{
	...
	msgLocalAddressReadFailed: "لم تتم قراءة عنوان محلي صالح؛ مرّره مباشرة، مثلاً: nt anonymous http localhost 3000",
	msgPortReadFailed:         "لم تتم قراءة منفذ صالح؛ مرّره مباشرة، مثلاً: nt anonymous http localhost 3000",
